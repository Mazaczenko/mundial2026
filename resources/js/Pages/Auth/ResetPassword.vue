...
<template>
    ...
    <div
        class="login-bg relative flex min-h-dvh flex-col items-center justify-center overflow-hidden px-4 py-12"
    >
        <!-- Pitch line overlay -->
        <div
            class="pitch-lines pointer-events-none absolute inset-0"
            aria-hidden="true"
        />
        ...
        <div class="relative z-10 mb-10 text-center">
            <div
                class="ball-float mx-auto mb-4 flex h-20 w-20 items-center justify-center"
            >
                <svg
                    viewBox="0 0 100 100"
                    class="h-full w-full drop-shadow-[0_0_24px_rgba(34,197,94,0.6)]"
                    aria-hidden="true"
                >
                    <circle cx="50" cy="50" r="47" fill="white" />
                    <polygon
                        points="50,5 62,30 88,30 67,48 75,73 50,56 25,73 33,48 12,30 38,30"
                        fill="#111827"
                        opacity="0.85"
                    />
                    <circle
            ...
            <h1
                class="font-russo text-5xl font-black uppercase tracking-widest text-white sm:text-6xl"
            >
                Mundial
                <span class="text-green-400">2026</span>
            </h1>
            <p
                class="font-chakra mt-2 text-sm font-medium uppercase tracking-[0.3em] text-green-400/80"
            >
        ...
        <div class="login-card relative z-10 w-full max-w-sm">
            ...
            <form @submit.prevent="submit" novalidate class="relative">
                <div class="mb-5 text-center">
                    <p
                        class="font-chakra text-xs font-medium uppercase tracking-widest text-green-400/70"
                    >
                        Ustaw nowe hasło
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label
                            for="email"
                            class="font-chakra mb-1.5 block text-xs font-semibold uppercase tracking-widest text-gray-300"
                        >
                            Email
                        </label>
                        <div class="relative">
                            <span
                                class="pointer-events-none absolute inset-y-0 left-3 flex items-center text-green-500/60"
                                aria-hidden="true"
                            >
                                <svg
                                    class="h-4 w-4"
                        ...
                        <InputError
                            ...
                            class="font-chakra mt-1.5 text-xs text-red-400"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button
                                ...
                                class="absolute inset-y-0 right-3 flex cursor-pointer items-center text-gray-500 transition-colors hover:text-green-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
                                :aria-label="
                                    showConfirm ? 'Ukryj hasło' : 'Pokaż hasło'
                                "
        ...
        <!-- Footer -->
        <p
            class="font-chakra relative z-10 mt-10 text-center text-xs uppercase tracking-widest text-gray-600"
        >
