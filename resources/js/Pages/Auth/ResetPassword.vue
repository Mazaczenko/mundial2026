        ...
        <div class="login-card relative z-10 w-full max-w-sm">
            ...
            <form @submit.prevent="submit" novalidate class="relative">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="password_confirmation" class="font-chakra mb-1.5 block text-xs font-semibold uppercase tracking-widest text-gray-300">
                            Powtórz hasło
                        </label>
                        <div class="relative">
                            <span class="pointer-events-none absolute inset-y-0 left-3 flex items-center text-green-500/60" aria-hidden="true">
                        ...
                        <InputError :message="form.errors.password_confirmation" class="mt-1.5 font-chakra text-xs text-red-400" />
                    </div>
                </div>
